...
export default function VaccinationSessionDetailsScreen() {
  ...
  const sessionData = {
    ...
    students: [
      ...
      },
      {
        ...
        status: "consented",
        vaccinated: false,
        notes: "Mild anxiety about needles",
      },
      {
        id: "s3",
        name: "Michael Brown",
      ...
      },
      {
        ...
        status: "declined",
        vaccinated: false,
        notes: "Parent declined due to previous reaction",
      },
      {
        id: "s5",
        name: "Daniel Wilson",
    ...
    return (
      <View style={styles.studentCard} key={item.id}>
        ...
        <View style={styles.studentActions}>
          ...
          {item.status === "consented" && !item.vaccinated && (
            <TouchableOpacity
              style={styles.recordButton}
              onPress={() => router.push(`/(nurse)/vaccinations/record-vaccination?sessionId=${id}&studentId=${item.id}`)}
            >
              <FontAwesome5 name="syringe" size={12} color="#fff" />
        ...
        {activeTab === "details" ? (
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.statsSection}>
              ...
              <View style={styles.statsGrid}>
                ...
                <View style={styles.statItem}>
                  <Text style={styles.statValue}>
                    {sessionData.students.filter((s) => s.vaccinated).length}
                  </Text>
          ...
          <View style={styles.studentsContainer}>
            ...
            <View style={styles.studentsList}>
              {sessionData.students.map((student) => renderStudentItem(student))}
            </View>
          </View>
        )}
      </ScrollView>
      ...
      <View style={styles.footer}>
        <TouchableOpacity 
          ...
          onPress={() => {
            ...
            console.log("Starting vaccination session")
          }}
        >
          <FontAwesome5 name="play" size={16} color="#fff" />
          <Text style={styles.startButtonText}>Start Vaccination Session</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  )

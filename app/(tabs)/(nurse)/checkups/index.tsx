...
const checkupSessions = [
  {
    ...
    status: "completed",
    totalStudents: 120,
    consentedStudents: 115,
    completedCheckups: 115,
    abnormalFindings: 12,
  },
  {
    id: "2",
  ...
  },
  {
    ...
    status: "upcoming",
    totalStudents: 120,
    consentedStudents: 70,
    completedCheckups: 0,
    abnormalFindings: 0,
  },
]

export default function NurseCheckupsScreen() {
  const renderSessionItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => router.push(`/(nurse)/checkups/session-details?id=${item.id}`)}
      >
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statItem}>
            <Text style={styles.statValue}>{item.completedCheckups}</Text>
            <Text style={styles.statLabel}>Completed</Text>
          </View>
          {item.status === "completed" && (
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: "#ff4d4f" }]}>{item.abnormalFindings}</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Health Checkup Sessions</Text>
        <Text style={styles.subtitle}>Manage school health checkup programs</Text>
      </View>
      ...
      <TouchableOpacity style={styles.addButton}>
        ...
        <Text style={styles.addButtonText}>New Checkup Session</Text>
      </TouchableOpacity>
    </SafeAreaView>
  )
}
